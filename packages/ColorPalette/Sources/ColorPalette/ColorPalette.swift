...
//        string += "accentList = \(self.accentList.map{$0.hexString}.joined(separator: ","))\n"
    ...
    public func withUpdatedName(_ name: String, background: NSColor? = nil,
                                sidebarBackground: NSColor? = nil, text: NSColor? = nil,
                                grayText: NSColor? = nil, disabledText: NSColor? = nil) -> ColorPalette {
        return ColorPalette(isNative: self.isNative, isDark: isDark,
                            ...
                            text: text ?? self.text,
                            grayText: grayText ?? self.grayText,
                            link: link,
                            accent: accent,
                            redUI: redUI,
                            greenUI: greenUI,
                            ...
                            grayUI: grayUI,
                            darkGrayText: disabledText ?? self.darkGrayText,
                            accentSelect: accentSelect,
                            selectText: selectText,
                            border: border,
                            grayBackground: grayBackground,
                            grayForeground: grayForeground,
                            grayIcon: grayText ?? self.grayIcon,
                            ...
                            grayTextBubble_incoming: grayText ?? self.grayTextBubble_incoming,
                            grayTextBubble_outgoing: grayTextBubble_outgoing,
                            grayIconBubble_incoming: grayText ?? self.grayIconBubble_incoming,
                            ...
                            textBubble_incoming: text ?? self.textBubble_incoming,
                            ...
                            chatReplyTextEnabled: text ?? self.chatReplyTextEnabled,
                            chatReplyTextDisabled: disabledText ?? self.chatReplyTextDisabled,
                            chatReplyTitleBubble_incoming: chatReplyTitleBubble_incoming,
                            chatReplyTitleBubble_outgoing: chatReplyTitleBubble_outgoing,
                            chatReplyTextEnabledBubble_incoming: text ?? self.chatReplyTextEnabledBubble_incoming,
                            chatReplyTextEnabledBubble_outgoing: chatReplyTextEnabledBubble_outgoing,
                            chatReplyTextDisabledBubble_incoming: disabledText ?? self.chatReplyTextDisabledBubble_incoming,
                            ...
                            chatBackground: background ?? self.chatBackground,
                            listBackground: sidebarBackground ?? self.listBackground,
                            listGrayText: grayText ?? self.listGrayText,
